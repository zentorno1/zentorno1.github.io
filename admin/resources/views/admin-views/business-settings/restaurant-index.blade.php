        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{translate('restaurant')}} {{translate('setup')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <form action="{{route('admin.business-settings.update-setup')}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                <label>{{translate('self_pickup')}}</label><small style="color: red">*</small>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="alert alert-warning sticky-top" id="alert_box" style="display:none;">
                                ...
                                <strong>{{ translate('Warning!') }}</strong> {{translate('language_warning')}} {{ translate('For documentaion') }} <a
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label>{{translate('email')}} {{translate('verification')}}
                                    ( OTP
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group pl-3">
                                        <div class="form-group">
                                            <label>{{translate('minimum_shipping_charge')}} </label><br>
                                        ...
                                        <div class="form-group">
                                            <label>{{translate('shipping_charge_per_km')}}</label><br>
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <div class="form-group pl-4">
                                            ...
                                            <label class=""
                                                   for="exampleFormControlInput1">{{translate('default_delivery_charge')}} </label>
                    ...
                    <div class="form-group mt-2">
                        <label>{{translate('logo')}}</label><small style="color: red">*
