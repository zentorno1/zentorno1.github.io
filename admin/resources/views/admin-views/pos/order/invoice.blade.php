            ...
            @if($detail->product)
                <tr>
                    ...
                    <td class="">
                        ...
                        <span style="display: block">{{translate('Discount')}} : {{ Helpers::set_symbol($detail['discount_on_product']*$detail['quantity']) }}</span>
                    </td>
                    <td style="width: 28%">
    ...
    <div class="row justify-content-md-end">
        <div class="col-md-7 col-lg-7">
            <dl class="row text-right" style="color: black!important;">
                ...
                <dd class="col-6" style="font-size: 20px">{{ Helpers::set_symbol($order->order_amount) }}</dd>
            </dl>
        </div>
    </div>
    <span>-------------------------------------------------------------------------------------</span>
