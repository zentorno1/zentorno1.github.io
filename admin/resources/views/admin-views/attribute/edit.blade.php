                            ...
                            <div class="col-12">
                                @foreach(json_decode($language) as $lang)
                                    ...
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                        ...
                                        <input type="text" name="name[]" class="form-control" value="{{$lang==$default_lang?$attribute['name']:($translate[$lang]['name']??'')}}" placeholder="{{ translate('New Attribute') }}" {{$lang == $default_lang? 'required':''}}>
                                    </div>
