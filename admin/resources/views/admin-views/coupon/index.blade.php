                    ...
                    <div class="row">
                        <div class="col-md-3 col-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="min_purchase" value="{{ old('min_purchase') ? old('min_purchase') : 0 }}" min="0" max="100000" class="form-control"
                        ...
                        <div class="col-md-3 col-6" id="max_discount_div">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" min="0" value="{{ old('max_discount') ? old('max_discount') : 0 }}" max="1000000" name="max_discount" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{translate('discount')}}</label>
                                <input type="number" step="0.01" min="1" max="10000" name="discount" value="{{old('discount')}}" class="form-control" required>
                            </div>
                        </div>
